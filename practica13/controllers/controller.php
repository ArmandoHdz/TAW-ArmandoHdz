		...
		foreach($datos as $row => $item){ 
			echo'<tr>
				  ...
				  echo '</tbody>
					...
					<td>'.$item["total"].'</td>';
					/*<td style="text-align: center;"><a href="index.php?action=detalles_producto&id='.$item["id_venta"].'"><button class="btn btn-danger">Eliminar</button></a></td>';*/
		}
	}
	...
	public function agregarVentaController(){
		...
		if(isset($_POST['agregar'])){
			if($_POST['codigo']){
				...
				Datos::cargarProductoModel($_POST['codigo']);
				$cargar = Datos::vistaProductosCargadosModel();
