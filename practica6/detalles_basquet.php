<?php 
    ...
    //se ejecuta la funcion de actualizar
		Update('basquetbolistas',$id, $nombre, $posicion, $dorsal, $carrera, $email);
    //se confirma el agregado y se redirecciona la pagina
		echo '<script> window.location = "ejercicio2.php"; </script>';
		die();
		
	}
  //se obtienen los datos de un solo jugador
	$player = getPlayer('basquetbolistas', $id);
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="large-9 columns">
        <h1>Ejercicio 2</h1>
        <h3>Actualizar registro de Basquetbolistas</h3>
