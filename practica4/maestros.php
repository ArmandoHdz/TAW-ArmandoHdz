      ...
      <div class="large-9 columns">
        ...
        <div class="large-9 columns">
          <ul class="right button-group">
            <li><a href="./agregar_maestro.php" class="button">Agregar</a></li>
          </ul>
        </div>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="./key_maestros.php?id=<?php echo $id; ?>" class="button radius tiny secondary">Ver detalles</a></td>
                  </tr>
                  <?php } ?>
                  <tr>
