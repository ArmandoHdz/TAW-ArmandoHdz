<?php 
	...
	class CRUD extends Conexion
	{
		...
		public function getUnidadesModel($matricula){
			$unidades = Conexion::conectar()->prepare(
				'SELECT g.numero_unidades as unidades,
				...
				INNER JOIN Teacher as t on g.id_teacher = t.id_teacher WHERE a.matricula = :matricula');
		...
		public function registroUnidadModel($datos){
			...
			$nuevo = Conexion::conectar()->prepare(
				"INSERT INTO Unidades (unidad, fecha_inicio, fecha_fin, id_grupo) VALUES (:unidad, :fecha_inicio, :fecha_fin, :id_grupo)");
		...
		public function getMatriculas(){
			$matriculas = Conexion::conectar()->prepare('SELECT matricula FROM Alumnos');
			$matriculas->execute();
		...
		public function registroVisitasModel($datos){
			...
			$nuevo = Conexion::conectar()->prepare(
			'INSERT INTO Visitas(hora_inicio, matricula, id_actividad, unidad, horario) VALUES(:hora_inicio, :matricula, :id_actividad, :unidad, :horario)');
