...
class Mvc{
	...
	public function vistaGruposController(){
		...
		foreach($grupos as $row => $item){ 
			echo'<tr>
					...
					<td>'.$item["teacher"].'</td>
					<td>'.$item["grupo"].'</td>
					<td>'. 0/*$item["unidades"]*/.'</td>
					<td>'. 0/*$item["horas_unidad"]*/.'</td>
	...
	public function vistaUnidadesController(){
		...
		foreach($unidades->fetchAll() as $row => $item){ 
			echo'<tr>
					...
					<td style="text-align: center;"><a href="index.php?user=admin&action=editar_unidad&id='.$item["id_unidad"].'&id_grupo='.$_GET["id_grupo"].'"><button class="btn btn-warning">Editar</button></a></td>';
	...
	public function agregarVisitaController(){
		...
		$matriculas = CRUD::getMatriculas();
		$actividades = CRUD::vistaActividadesModel();
		if(isset($_GET['matricula']))
			$alumno = CRUD::getUnidadesModel($_GET['matricula']);
		...
		echo "<script>
				function activa_grupo(matricula){
		...
		echo '  <div class="card-body">
				  <div class="form-group row">
	                ...
	                <div class="col-sm-9">
	                  <select class="form-control select2" name="matricula" onChange="activa_grupo(this)">';
	                if(isset($_GET['matricula']))
	            ...
	            echo '</select>
	               ...
	               <div class="form-group row">
	                <div class="col-sm-3" align="right">
	              	...
	              	<div class="col-sm-9">
	                  <input type="text" class="form-control" name="alumno" disabled ';
	                  if(isset($_GET['matricula'])) echo 'value="'.$alumno[0]['alumno'].'"';
	                  echo '>
	                </div>
	              </div>
	               <div class="form-group row">
	                <div class="col-sm-3" align="right">
	                  ...
	                  if(isset($_GET['matricula'])) echo 'value="'.$alumno[0]['teacher'].'"';
	                  echo '>
	                </div>
	              </div>
	               <div class="form-group row">
	                <div class="col-sm-3" align="right">
	                  ...
	                  if(isset($_GET['matricula'])) echo 'value="'.$alumno[0]['grupo'].'"';
	                  echo '>
	                </div>
	              </div>
